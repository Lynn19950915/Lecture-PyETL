        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>
                    ...
                    <br><br>
                    系統出現異常？<button style="border: none" onclick="window.open('mailto: clickdiary@stat.sinica.edu.tw')"><b>回報客服人員</b></button>
                </p>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>
                    ...
                    <br><br>
                    系統出現異常？<button style="border: none" onclick="window.open('mailto: clickdiary@stat.sinica.edu.tw')"><b>回報客服人員</b></button><br>
                    5 秒後將為您導回：接觸對象管理頁
                </p>
            </div>
