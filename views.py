...
line_bot_api="4YcqMM3oev8a9msu8gl95jpsCh9iwcCfYpdb7WfU39fNvNLiME75C6ul8BiXN5l+5R1CP+o8wLQ7eujsZjNlc3z2IxkPy4pJcFQfKPIkK9Pjgfs5wspBERYgO6SV+N2d2ERu8nTEUy7RZ4nA4GpW3QdB04t89/1O/w1cDnyilFU="
handler="8b834d3bb6b8008b8c81f6d1e7de4fcf"
parser="8b834d3bb6b8008b8c81f6d1e7de4fcf"
        ...
        for event in events:
            if isinstance(event, MessageEvent):
                if isinstance(event.message, TextMessage):
                    ...
                    if mtext=="00是，開始登錄":
                    ...
                    elif mtext=="01有用資訊" or mtext=="01有靈性啟發" or mtext=="01有趣" or mtext=="01不認同" or mtext=="01有心情感受":
                        ...
                        line_bot_api.reply_message(event.reply_token, TextSendMessage(
                            text="謝謝您！若要登錄主動發訊息內容，請點按下方圖片選單；如果其他客服問題，請點選以下連結 https://line.me/R/ti/p/%40670gpxyo"
                        ))
                        return HttpResponse("")
